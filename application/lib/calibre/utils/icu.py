...
icu_unicode_version = "1.0"
_nmodes = {'NFC': 0, 'NFD': 1, 'NFKC': 2, 'NFKD': 3}
...
title_case = lambda x: x.capitalize()
...
swapcase = swap_case = lambda x: x.swapcase()
