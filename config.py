...
DATABASE_ENGINE = "mongodb"  #"datastore", "mysql", "sqlite", "postgresql", "cockroachdb", "mongodb"
...
#Choose the backend service for sending emails, either "gae", "sendgrid", "smtp", "savetolocal"
SEND_MAIL_SERVICE = "savetolocal"
